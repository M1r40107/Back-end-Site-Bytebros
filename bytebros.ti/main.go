...
func main() {
	...
	contatoRoutes := router.Group("/api/contatos")
	{
		contatoRoutes.POST("", handlers.CriarContato)
	}
	...
	protected.Use(handlers.AuthMiddleware())
	{
		...
		adminRoutes.Use(handlers.AdminMiddleware())
		{
			...
			adminRoutes.GET("/contatos", handlers.ListarContatos)
			adminRoutes.GET("/contatos/:id", handlers.ObterContato)
			adminRoutes.PUT("/contatos/:id/status", handlers.AtualizarStatusContato)
			adminRoutes.DELETE("/contatos/:id", handlers.DeletarContato)
		}
	}
